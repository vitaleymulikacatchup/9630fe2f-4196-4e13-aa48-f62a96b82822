...
export const metadata: Metadata = {
  title: "Webild - Build Your Digital Presence",
  description: "Create a professional website with ease using Webild.",
  openGraph: {
    title: "Webild - Build Your Digital Presence",
    description: "Create a professional website with ease using Webild.",
    siteName: "Webild",
    images: [{
      url: "https://images.pexels.com/photos/34326374/pexels-photo-34326374.png?auto=compress&cs=tinysrgb&h=650&w=940"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Webild - Build Your Digital Presence",
    description: "Create a professional website with ease using Webild.",
    images: ["https://images.pexels.com/photos/34326374/pexels-photo-34326374.png?auto=compress&cs=tinysrgb&h=650&w=940"]
  }
};
